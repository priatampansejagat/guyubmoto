          ...
          <div class="topnav-right sidebarCollapse_sidebar">
            <ul class="navbar-nav mr-auto">
              <li class="nav-item">
                ...
                <button type="button" id="sidebarCollapse" class="btn btn-primary-outline btn-light text-info">
          ...
          ?>
                ...
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="MyWorks">
                        <li>
                            <a href="<?php echo base_url().'/family/myworks/photography' ?>">Photography</a>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    <a href="#AboutMe" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">About Me</a>
                    <ul class="collapse list-unstyled" id="AboutMe">
                        <li>
                            <a href="<?php echo base_url().'/family/aboutme/biography' ?>">Biography</a>
                        </li>
                        <li>
                            <a href="#">Contact</a>
                        </li>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#sidebarCollapse').on('click', function () {
            $('#sidebar, #content, #content_header').toggleClass('active');
